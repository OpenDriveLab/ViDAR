...
# latent rendering configurations.
...
model = dict(
    ...
    backwarded_prev_frame_num=backwarded_prev_frame_num,
    img_backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
load_from = 'work_dirs/vidar_full_nusc_1future/latest.pth'
work_dir = 'work_dirs/fine-tune/vidar_full_nusc_1future'
