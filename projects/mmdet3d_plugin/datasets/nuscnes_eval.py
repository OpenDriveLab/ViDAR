...
class NuScenesEval_custom(NuScenesEval):
    ...
    def __init__(self,
        ...
        # TODO: un-comment it when evaluating on train set.
        # pred_sample = self.pred_boxes.sample_tokens
        # self.gt_boxes.boxes = dict([(idx, self.gt_boxes.boxes[idx]) for idx in pred_sample])
